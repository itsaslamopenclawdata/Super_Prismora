...
export default function MeowIQPage() {
  ...
  const handleCapture = async (file: File) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to identify cat breed');
      }

      const result = await response.json();
      sessionStorage.setItem('meowiq_result', JSON.stringify(result));

      router.push('/meowiq/result');
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-100 to-white dark:from-purple-950 dark:to-neutral-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 mb-4 bg-purple-200 dark:bg-purple-900 rounded-full">
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white dark:bg-neutral-800 rounded-xl p-8 shadow-lg">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Analyzing Cat</h3>
                <p className="text-neutral-600 dark:text-neutral-400 mb-4">
                  Identifying breed...
                </p>
                <div className="w-full bg-neutral-200 dark:bg-neutral-700 rounded-full h-2 overflow-hidden">
                  <div className="bg-purple-600 h-full animate-[loading_1.5s_ease-in-out_infinite]" style={{ width: '60%' }}></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          <div className="bg-white dark:bg-neutral-800 rounded-lg p-4 shadow-md">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 bg-purple-200 dark:bg-purple-900 rounded-lg flex items-center justify-center">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              Identify 70+ cat breeds
            </p>
          </div>

          <div className="bg-white dark:bg-neutral-800 rounded-lg p-4 shadow-md">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 bg-pink-200 dark:bg-pink-900 rounded-lg flex items-center justify-center">
                <svg className="w-5 h-5 text-pink-700 dark:text-pink-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-lg p-4 shadow-md">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 bg-indigo-200 dark:bg-indigo-900 rounded-lg flex items-center justify-center">
