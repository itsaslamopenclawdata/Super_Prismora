...
export default function EntomIQPage() {
  ...
  const handleCapture = async (file: File) => {
    ...
    try {
      ...
      formData.append('type', 'insect');

      const response = await fetch('/api/identify/insect', {
        method: 'POST',
        body: formData,
      });
      ...
      sessionStorage.setItem('entomiq_result', JSON.stringify(result));

      router.push('/entomiq/result');
    } catch (error) {
      console.error('Identification error:', error);
      alert('Failed to identify insect. Please try again.');
    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white dark:from-yellow-950 dark:to-neutral-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-yellow-600 to-orange-600 text-transparent bg-clip-text">
            EntomIQ
          </h1>
          <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-4">
            Identify insects with danger assessment
          </p>
          <div className="max-w-2xl mx-auto bg-warning-50 dark:bg-warning-950 border border-warning-200 dark:border-warning-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <svg className="w-6 h-6 text-warning-600 dark:text-warning-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <div className="text-left">
                <p className="font-semibold text-warning-900 dark:text-warning-100 mb-1">
                  Insect Danger Assessment
                </p>
                <p className="text-sm text-warning-800 dark:text-warning-200">
                  This app identifies insects and assesses potential danger including venomous bites, stings, or allergic reactions. Always exercise caution around unfamiliar insects.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white dark:bg-neutral-800 rounded-xl p-8 shadow-lg">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Analyzing Insect</h3>
                <p className="text-neutral-600 dark:text-neutral-400 mb-4">
                  Identifying species and assessing danger...
                </p>
                <div className="w-full bg-neutral-200 dark:bg-neutral-700 rounded-full h-2 overflow-hidden">
                  <div className="bg-yellow-600 h-full animate-[loading_1.5s_ease-in-out_infinite]" style={{ width: '60%' }}></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          <div className="bg-white dark:bg-neutral-800 rounded-lg p-4 shadow-md">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              Harmless insects identified clearly
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-lg p-4 shadow-md">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              May bite, sting, or cause irritation
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-lg p-4 shadow-md">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-semibold">Dangerous</h3>
            </div>
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              Venomous or potentially harmful
            </p>
          </div>
        </div>
      </div>
