 ...
 * Registration Page
 *
 * This page allows new users to create an account with their email and password.
 * Also supports OAuth providers (GitHub, Google).
 */
        ...
        <Card variant="default" padding="lg">
          <CardHeader>
            ...
            <p className="text-center text-gray-600 dark:text-gray-400 mt-2">
              Join PhotoIdentifier to identify photos with AI
            </p>
          </CardHeader>
